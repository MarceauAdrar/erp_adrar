...
<body>
    <section>
        ...
        <div class="droit">
            <h1>Bienvenue sur l'ERP</h1>
            <form action="../src/c/c_requetes.php" method="post">
                <input type="hidden" name="for_login_csrf" value="<?= $csrfToken ?>">
                <div>
                    <label for="form_login_mail">Email</label><br/>
                    <input type="text" name="form_login_mail">
                </div>
                <div>
                    <label for="form_login_pass">Mot de passe</label><br/>
                    <input type="text" name="form_login_pass">
                </div>
