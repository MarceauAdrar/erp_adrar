...
include_once("./header.php"); ?>
    ...
    <script>
        ...
        function chargerCorrection() {
            const link = "http://" + SERVER_NAME + "/public/stagiaires/" + "<?=$stagiaire_username?>" + "/" + sessionStorage.getItem("module") + "/tp" + sessionStorage.getItem("tp") + ".html";
            const linkCorrection = "http://" + SERVER_NAME + "/modules/" + sessionStorage.getItem("module") + "/corrections/tp" + sessionStorage.getItem("tp") + ".html";
