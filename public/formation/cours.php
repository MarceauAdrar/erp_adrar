...
<div class="container">
    <div class="row pt-5">
        ...
        <input type="search" class="form-control" id="course-search-kw" onchange="getCourses(document.querySelector('#hidden_input_module').value , this.value);" value="<?=@$_GET['q']?>" placeholder="Votre recherche...">
    </div>
