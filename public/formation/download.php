...
if(isset($_GET['q']) && !empty($_GET['q'])) {
    $req = $db->prepare("SELECT nom_formateur, prenom_formateur, cours_ressource_archive 
    ...
    if(!empty($ressource)) {
        $fichier = "../../src/v/formateurs/".strtolower(substr($_SESSION['utilisateur']['prenom_formateur'], 0, 1) . $_SESSION['utilisateur']['nom_formateur']).'/'.$ressource['cours_ressource_archive'];
