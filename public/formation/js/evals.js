...
function reloadBoxs() {
    var stagiaire_username = sessionStorage.getItem("stagiaire_username");
    var link = "http://" + SERVER_NAME + "/erp/public/formation/stagiaires/" + stagiaire_username + "/html-css/tp" + sessionStorage.getItem("tp");
    var ext;
