if(document.querySelector('#signature-pad')) {
    ...
    approveButton.addEventListener('click', function (event) {
        document.querySelector('input[name="form_signature_formateur"]').value = document.querySelector('#signature-pad').toDataURL('image/png');
    });
    
    clearButton.addEventListener('click', function (event) {
        document.querySelector('input[name="form_signature_formateur"]').value = "";
        signaturePad.clear();
    });
}